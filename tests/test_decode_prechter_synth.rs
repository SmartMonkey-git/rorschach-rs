...
fn test_decode() {
    let mut phq9_data =
        Reader::from_path("/Users/rouvenreuter/data/prechter/synth/PHQ-9.csv").unwrap();
    let mut gad7_data =
        Reader::from_path("/Users/rouvenreuter/data/prechter/synth/GAD-7.csv").unwrap();
    let mut asrm_data =
        Reader::from_path("/Users/rouvenreuter/data/prechter/synth/ASRM.csv").unwrap();
    ...
    let mut output =
        File::create("/Users/rouvenreuter/data/prechter/synth/rorschach_output.csv").unwrap();
